...
from website.graphite.util import json
from website.graphite.render.views import parseOptions
from website.graphite.render.evaluator import evaluateTarget
from website.graphite.storage import STORE
...
def graphlot_render(request):
    ...
    return render_to_response("graphite/graphlot.html", context)
...
def browser(request):
  ...
  return render_to_response("graphite/browser.html", context)
