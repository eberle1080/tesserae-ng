...
from website.graphite.render.datalib import fetchData, TimeSeries, timestamp
from website.graphite.render.attime import parseTimeOffset

from website.graphite.events import models
#XXX format_units() should go somewhere else
from os import environ
if environ.get('READTHEDOCS'):
  format_units = lambda *args, **kwargs: (0,'')
else:
  from website.graphite.render.glyph import format_units
