...
try:  # See if there is a system installation of pytz first
  ...
  from website.graphite.thirdparty import pytz

from website.graphite.util import getProfileByUsername, json, unpickle
from website.graphite.remote_storage import HTTPConnectionWithTimeout
from website.graphite.logger import log
from website.graphite.render.evaluator import evaluateTarget
from website.graphite.render.attime import parseATTime
from website.graphite.render.functions import PieFunctions
from website.graphite.render.hashing import hashRequest, hashData
from website.graphite.render.glyph import GraphTypes
...
def delegateRendering(graphType, graphOptions):
  ...
  for server in servers:
    ...
    try:
      ...
      # Send the request
      try:
        connection.request('POST','/graphite/render/local/', postData)
...
def errorPage(message):
  template = loader.get_template('graphite/500.html')
