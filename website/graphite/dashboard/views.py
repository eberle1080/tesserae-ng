...
from website.graphite.dashboard.models import Dashboard
from website.graphite.render.views import renderView
...
def dashboard(request, name=None):
  ...
  return render_to_response("graphite/dashboard.html", context)
...
def help(request):
  context = {}
  return render_to_response("graphite/dashboardHelp.html", context)
