    ...
    $.fn.graphiteGraph = function(config) {
        ...
        return this.each(function() {
            ...
            var build_url_graph = function() {
                var url = url_host + url_path_prefix + '/graphite/graphlot/?';
                params = build_when();
            ...
            var build_url_rawdata = function (series) {
                var url = url_host + url_path_prefix + '/graphite/graphlot/rawdata?';
                params = build_when();
                params.push('target=' + series);
                return url + params.join("&");
            }
            ...
            var build_url_events = function (tags) {
                var url = url_host + url_path_prefix + '/graphite/events/get_data?';
                params = build_when();
                if (tags != "*") {
            ...
            wrap.find('.g_newmetric').each(function () {
                ...
                edit.keydown(function(e) {
                    if(e.which===13) { // on enter
                        ...
                        var new_row = $('<tr class="g_metricrow"><td><a href=#><span class="g_metricname">'+edit.val()+'</span></a></td><td><a href=#><span class="g_yaxis">one</span></a></td><td class="g_killrow"><img src="/media/graphite/img/delete.gif"></td></tr>');
                            setup_row(new_row);
