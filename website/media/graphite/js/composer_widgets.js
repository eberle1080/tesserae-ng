...
function createComposerWindow(myComposer) {
  ...
  var win = new Ext.Window({
    ...
    buttonAlign: 'left',
    items: { html: "<img id='image-viewer' src='/graphite/render'/>", region: "center" },
    listeners: {
...
function createToolbarButton(tip, icon, handler) {
  return new Ext.Toolbar.Button({
    style: "padding-left:10pt; background:transparent url(/media/graphite/img/" + icon + ") no-repeat scroll 0% 50%",
    handler: handler,
