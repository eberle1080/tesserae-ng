...
function setupSearchForm(formEl) {
  ...
  var helpPage = '"/media/graphite/html/searchHelp.html"';
...
function createCompleterPanel() {
  ...
  return new Ext.Panel({
    ...
    items: [
      metricCompleter,
      new Ext.form.Label({html: '<a id="completerHelpLink" href="/media/graphite/html/completerHelp.html", target="_new"> Help </a>'})
    ]
  });
...
function setupCompleterForm(formEl) {
  ...
  var helpAction = 'javascript: void window.open';
  var helpPage= '"/media/graphite/html/completerHelp.html"';
